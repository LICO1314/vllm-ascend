...
class AscendModelSlimConfig(QuantizationConfig):
    ...
    def get_cache_scale(self, name: str) -> str | None:
        """Map checkpoint C8 KV scale names to vLLM parameter names.

        Returns the vLLM internal parameter name for C8 KV cache scale/offset
        weights, or None if the weight is not a C8 scale.
        """
